    ...
    <div>
        <form:form action="save" method="post" modelAttribute="declare">
            <table class="table table-bordered">
                ...
                <tr>
                    <th colspan="6">Lịch sử phơi nhiễm: Trong vòng 14 ngày qua, anh/chị có:</th>
                </tr>
                <tr>
                    <th colspan="6">
                        <form:checkbox path="exposuringHistory"
                                       value="Đến trang trại chăn nuôi/chợ buôn bán động vật sống/cơ sở giết mổ động vật/tiếp xúc động vật"/>
                ...
                <tr>
                    <th colspan="6">
                        <form:checkbox path="exposuringHistory"
                                       value="Tiếp xúc gần (<2m) với người mắc bệnh viêm nhiễm đường hô hấp do nCoV"/>
                        Tiếp xúc gần (<2m) với người mắc bệnh viêm nhiễm đường hô hấp do nCoV
                    </th>
                </tr>
                <tr>
                    <th></th>
                    <td colspan="2"><input type="submit" role="button" class="btn btn-outline-primary"
                                           value="Gửi tờ khai">
                    </td>
                    <td colspan="2"><input type="reset" role="button" class="btn btn-outline-secondary"
                                           value="Khai lại">
                    </td>
                    <th></th>
                </tr>
