    ...
    <div>
        <form:form action="save" method="post" modelAttribute="declare">
            <table class="table table-bordered">
                ...
                <tr>
                    <th colspan="6">Địa chỉ liên lạc:</th>
                </tr>
                <tr>
                    <td>Thành phố: </td>
                    <td><form:input path="city" readonly="true"/></td>
                    <td>Thành phố: </td>
                    <td><form:input path="district" readonly="true"/></td>
                    <td>Thành phố: </td>
                    <td><form:input path="ward" readonly="true"/></td>
                </tr>
                <tr>
                    <td colspan="2">Địa chỉ nơi ở: </td>
                    <td colspan="4"><form:input path="address" readonly="true"/></td>
                </tr>
                <tr>
                    <td colspan="1">Đỉện thoại: </td>
                    <td colspan="2"><form:input path="phone" readonly="true"/></td>
                    <td colspan="1">Email: </td>
                    <td colspan="2"><form:input path="email" readonly="true"/></td>
                </tr>
                <tr>
                    <td colspan="6">Triệu chứng: </td>
                </tr>
                <tr>
                    <td colspan="6"><form:textarea rows="1" cols="160" path="status" readonly="true"/></td>
                </tr>
                <tr>
                    <td colspan="6">Lịch sử phơi nhiễm: </td>
                </tr>
                <tr>
                    <td colspan="6"><form:textarea cols="160" rows="2" path="exposuringHistory" readonly="true"/></td>
                </tr>
                <tr>
