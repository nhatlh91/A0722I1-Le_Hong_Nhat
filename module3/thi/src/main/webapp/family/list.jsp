...
<table class="table table-bordered" id="pagination-table">
    ...
    <c:forEach items="${families}" var="family">
        ...
        <tr>
            ...
            <td><fmt:formatDate value="${family.getCreateDate()}" pattern="dd-MM-yyyy"/></td>
            <td>${family.getAddress()}</td>
            <td>
                <a href="/families?action=edit&fid=${family.getFid()}" class="btn-primary btn">Sua</a>
                <a href="/families?action=detail&fid=${family.getFid()}" class="btn-primary btn">Xem thanh vien</a>
            </td>
        </tr>
    </c:forEach>
    </tbody>
