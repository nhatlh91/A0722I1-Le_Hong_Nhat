...
-- Khởi tạo dữ liệu cho table vi_tri
create table vi_tri (
ma_vi_tri tinyint primary key auto_increment,
...
-- Khởi tạo dữ liệu cho table trinh_do
create table trinh_do (
ma_trinh_do tinyint primary key auto_increment,
ten_trinh_do varchar(30)
);
...
-- Khởi tạo dữ liệu cho table bộ phận
create table bo_phan (
ma_bo_phan tinyint primary key auto_increment,
...
ngay_sinh date,
so_cmnd varchar(20),
luong int check (luong >= 0) default 0,
...
-- Khởi tạo dữ liệu cho table loại khách
create table loai_khach (
ma_loai_khach tinyint primary key auto_increment,
ten_loai_khach varchar(10)
);
...
-- Khởi tạo dữ liệu cho table khách hàng
create table khach_hang (
ma_khach_hang tinyint primary key auto_increment,
ho_ten varchar(50),
ngay_sinh date,
gioi_tinh tinyint check (gioi_tinh between 0 and 1) not null,
so_cmnd varchar(20),
so_dien_thoai varchar(20),
email varchar(30),
dia_chi varchar(50),
ma_loai_khach tinyint,
...
-- Khởi tạo dữ liệu cho table kiểu thuê
create table kieu_thue (
ma_kieu_thue tinyint primary key auto_increment,
...
-- Khởi tạo dữ liệu cho table dịch vụ
create table dich_vu (
ma_dich_vu tinyint primary key auto_increment,
ten_dich_vu varchar(50) not null,
dien_tich int not null check (dien_tich>0),
chi_phi_thue int not null check (chi_phi_thue>0),
so_nguoi_toi_da tinyint not null check (so_nguoi_toi_da>0),
tieu_chuan_phong varchar(10) not null,
mo_ta_tien_nghi_khac varchar(50),
dien_tich_ho_boi int default null check (dien_tich_ho_boi > 0),
so_tang tinyint default null check (so_tang > 0),
ma_kieu_thue tinyint,
ma_loai_dich_vu tinyint,
...
values 	('Villa Beach Front',25000,10000000,10,'VIP','Có hồ bơi',500,4,3,1),
		('House Princess 01',14000,5000000,7,'VIP','Có thêm bếp nướng',default,3,2,2),
		('Room Twin 01',5000,1000000,2,'NORMAL','Có tivi',default,default,4,3),
...
-- Khởi tạo dữ liệu cho table Hợp đồng
create table hop_dong (
ma_hop_dong tinyint primary key auto_increment,
ngay_lam_hop_dong date not null,
ngay_ket_thuc date not null,
tien_dat_coc int not null default 0 check (tien_dat_coc >= 0),
ma_nhan_vien tinyint,
ma_khach_hang tinyint,
ma_dich_vu tinyint,
...
-- -- Khởi tạo dữ liệu cho table Hợp đồng chi tiết
create table hop_dong_chi_tiet (
ma_hop_dong_chi_tiet tinyint primary key auto_increment,
so_luong tinyint not null check (so_luong > 0),
ma_hop_dong tinyint,
ma_dich_vu_di_kem tinyint,
